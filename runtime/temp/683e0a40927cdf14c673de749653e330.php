<?php /*a:1:{s:55:"D:\localhost\auth\application\admin\view\role\edit.html";i:1542088031;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<form class="layui-form" action="">
  ...
  <div class="layui-form-item">
    ...
    <?php if($info['status'] == '1'): ?>
      ...
      <?php else: ?>
      <input type="checkbox" name="status" lay-text="ON|OFF" lay-skin="switch">
      <?php endif; ?>
    </div>
  </div>
  <div class="layui-form-item">
    <div class="layui-input-block">
    	...
    	<input type="hidden"  value="<?php echo url('role/doEdit'); ?>" class="base_url"/>
