layui.use(['laydate', 'laypage', 'layer', 'table', 'carousel', 'upload', 'element', 'slider'], function(){
  ...
  //}
    ...
    ,cols: [[ //表头
       {field: 'nickname',width: '60%',  title: '用户名',align:'center'}
       ,{field: 'province',width: '10%',  title: '省',align:'center'}
       ,{field: 'addtime',width: '10%',  title: '加入时间',align:'center',templet:'#createTime'}
