...
//创建一个上传组件
  ...
  //}
    ...
    ,cols: [[ //表头
       ...
       ,{field: 'tel',width: '20%',  title: '电话',align:'center'}
       ,{field: 'title',width: '20%',  title: '标题',align:'center'}
       ,{field: 'item_img',width: '20%',  title: '图片',align:'center',templet:'#img'}
       ,{field: 'sex',width: '10%',  title: '性别',align:'center',templet:'#sex'}
       ,{field: 'create_time',width: '10%',  title: '加入时间',align:'center',templet:'#createTime'}
  ...
  ,done:function(res,curr,count){
      hoverOpenImg();//显示大图
      //预览表格中的所有图片，必须放在这里，等表格加载完了，才能获取到图片
      layer.photos({
    	  photos: '.layer-photos-demo'//装图片的容器
